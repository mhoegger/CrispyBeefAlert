...
class MenuAlertBot:
    ...
    def __search_menu_for_user(self, chat_id: int, user_menu: str, user_mensa: str) -> bool:
        c = self.conn.cursor()
        ...
        if len(found_mensi) > 0:
            ...
            for found_mensa in found_mensi:
                if not found_menu:
                    ...
                    self.db.writeMenu(user_menu)
                    self.db.write_alert(chat_id, found_mensa, user_menu)
                else:
                    if self.__search_menu_for_user(chat_id, found_mensa, user_mensa):
    ...
    def delete_alert(self, chat_id: int, user_mensa: str, user_menu: str) -> str:
        ...
        if len(found_mensi) > 0:
            ...
            if not found_menu:
                ...
                for found_mensa in found_mensi:
                    if self.__search_menu_for_user(chat_id, found_mensa, found_menu):
